    ...
    <script>
        $(function () {
            ...
            $("#edit_table_body").on("click",".searchproduct",function () {
                ...
                currentTr.find("[tag='amount']").text((number*salePrice).toFixed(2));
                ...
                if($("#edit_table_body tr").size() > 1){
                    ...
                    firstTr.find("[tag='salePrice']").val("");
            ...
            $(".appendRow").click(function () {
                ...
                newLine.find("[tag='salePrice']").val("");
            ...
            $("#editForm").submit(function () {
                $("#edit_table_body tr").each(function (index,val) {
                    ...
                    $(val).find("[tag=salePrice]").prop("name","items["+index+"].salePrice");
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <select id="clientId" class="ui_select03" name="client.id">
                            <c:forEach var="client" items="${clients}">
                                <option value="${client.id}" ${entity.client.id==client.id ?"selected='selected'":""}>${client.name}</option>
                            </c:forEach>
                        </select>
                    </td>
                </tr>
