    ...
    <script>
        $(function () {
            $("#editForm").ajaxForm(function (data) {
                if(data.success){
                    showDialog("编辑成功",function () {
                        location.href = "/systemMenu/query.do?parentId=${parent.id}";
                    });
                }
            });
        });
    ...
    <div id="container">
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                <tr>
                    <td class="ui_text_rt" width="140">父菜单称</td>
                    <td class="ui_text_lt">
                        <input disabled value="${parent.name}" class="ui_input_txt02"/>
